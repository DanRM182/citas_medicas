...
public record CitaRequest(
        ...
        @Schema(
                description = "Fecha y gora programada para la cita. Debe ser una fecha y hora actual o futura",
                example = "25/09/2026 10:36", type = "string", format = "date-time")
        @NotNull(message = "La fecha de la cita debe ser futura")
        @FutureOrPresent(message = "La fecha de la cita debe ser futúra")
